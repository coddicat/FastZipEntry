...
namespace FastZipEntry
{
    internal static class ZipHelper
    {
        ...
        private static readonly DateTime s_invalidDateIndicator = new(ValidZipDate_YearMin, 1, 1, 0, 0, 0);
        ...
        internal static byte[] GetEncodedTruncatedBytesFromString(string? text, Encoding? encoding, int maxBytes)
        {
            bool isUTF8;
