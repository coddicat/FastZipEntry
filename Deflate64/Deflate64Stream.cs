// -----------------------------------------------------------------------
// <copyright file="DeflateMamagedStream.cs">
...
namespace FastZipEntry.Deflate64
{
    ...
    internal sealed partial class Deflate64Stream : Stream
    {
        ...
        internal Deflate64Stream(Stream stream, ZipEntry.CompressionMethodValues method, long uncompressedSize = -1)
        {
            ...
            Debug.Assert(method == ZipEntry.CompressionMethodValues.Deflate64);

            _inflater = new InflaterManaged(method == ZipEntry.CompressionMethodValues.Deflate64, uncompressedSize);
